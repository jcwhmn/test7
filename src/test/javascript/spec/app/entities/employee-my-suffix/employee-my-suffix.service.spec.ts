...
import { EmployeeMySuffix } from '@/shared/model/employee-my-suffix.model';
...
describe('Service Tests', () => {
  describe('EmployeeMySuffix Service', () => {
    ...
    beforeEach(() => {
      service = new EmployeeMySuffixService();
    ...
    describe('Service methods', () => {
      ...
      it('should not create a EmployeeMySuffix', async () => {
      ...
      it('should not update a EmployeeMySuffix', async () => {
      ...
      it('should partial update a EmployeeMySuffix', async () => {
      ...
      it('should not partial update a EmployeeMySuffix', async () => {
      ...
      it('should not return a list of EmployeeMySuffix', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a EmployeeMySuffix', async () => {
