<template>
  <div class="row justify-content-center">
    <div class="col-8">
      <div v-if="employee">
        <h2 class="jh-entity-heading" data-cy="employeeDetailsHeading"><span>EmployeeMySuffix</span> {{ employee.id }}</h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span>{{ employee.hireDate | formatDate }}</span>
          </dd>
          <dt>
            <span>Salary</span>
          </dt>
        ...
        <router-link
          v-if="employee.id"
          :to="{ name: 'EmployeeMySuffixEdit', params: { employeeId: employee.id } }"
          custom
          v-slot="{ navigate }"
        >
...
<script lang="ts" src="./employee-my-suffix-details.component.ts"></script>
