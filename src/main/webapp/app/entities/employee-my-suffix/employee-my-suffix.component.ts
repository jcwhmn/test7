...
export default class EmployeeMySuffix extends mixins(JhiDataUtils) {
  ...
  public mounted(): void {
    this.retrieveAllEmployeeMySuffixs();
  }
  ...
  public retrieveAllEmployeeMySuffixs(): void {
  ...
  public prepareRemove(instance: IEmployeeMySuffix): void {
  ...
  public removeEmployeeMySuffix(): void {
    this.employeeService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A EmployeeMySuffix is deleted with identifier ' + this.removeId;
