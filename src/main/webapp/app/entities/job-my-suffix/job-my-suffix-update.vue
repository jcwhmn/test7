  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="test7App.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">Create or edit a JobMySuffix</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-my-suffix-jobTitle">Job Title</label>
            <input
              type="text"
              class="form-control"
              name="jobTitle"
              id="job-my-suffix-jobTitle"
              data-cy="jobTitle"
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-my-suffix-minSalary">Min Salary</label>
            <input
              type="number"
              class="form-control"
              name="minSalary"
              id="job-my-suffix-minSalary"
              data-cy="minSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-my-suffix-maxSalary">Max Salary</label>
            <input
              type="number"
              class="form-control"
              name="maxSalary"
              id="job-my-suffix-maxSalary"
              data-cy="maxSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" for="job-my-suffix-employee">Employee</label>
            <select class="form-control" id="job-my-suffix-employee" data-cy="employee" name="employee" v-model="job.employee">
...
<script lang="ts" src="./job-my-suffix-update.component.ts"></script>
